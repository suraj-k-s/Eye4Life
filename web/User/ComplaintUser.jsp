    ...
    <body>
        <%
            if(request.getParameter("txt_save")!=null){
                String insqry="insert into tbl_complaint(complaint_subject,complaint_content,user_id)values('"+request.getParameter("txt_subject")+"','"+request.getParameter("txt_complaint")+"','"+session.getAttribute("uid")+"')";
            if(comp.executeCommand(insqry)){
                      %>
                      <script>
                          alert("Sended");
                          window.location='ComplaintUser.jsp';
                      </script>
                      <%
            }
            }
        ...
        <form method="post" action="">
            <table border="2" colspan="2" align="center">
                ...
                <tr>
                    <td>Complaint</td>
                    <td><textarea name="txt_complaint" required autocomplete="off"></textarea></td>
                </tr>
                  <tr>
