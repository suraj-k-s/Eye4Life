          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" href="../Guest/RecoveryPassword.jsp">Change Password</a></li>
               <li class="nav-item px-2"><a class="nav-link" href="DeathCase.jsp">Death Case</a></li>
            
          
               <li class="nav-item px-2"><a class="nav-link" href="UserReport.jsp">Result</a></li>
                   <li class="nav-item px-2"><a class="nav-link" href="FeedbackUser.jsp">Feedback</a></li>
               <li class="nav-item px-2"><a class="nav-link" href="ComplaintUser.jsp">Complaint</a></li>
            </ul><a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="CheckupAppointment.jsp">Book Appointment</a>
          </div>
        </div>
      </nav>
        <br><br><br><br>
        <div id="tab" align="center" style="min-height: 520px">