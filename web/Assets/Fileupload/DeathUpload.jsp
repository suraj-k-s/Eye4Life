...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txt_certificate"))//write the name of image here it is img_product
                      {
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_case(case_hospitalname,case_hospitaladdress,case_hospitalcontact,case_deathcertificate,nominee_id,case_status,case_regdate)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + proof + "','"+value[3]+"',0,curDate())" ;
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../User/DeathCase.jsp'
