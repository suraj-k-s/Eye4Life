...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txt_file"))//write the name of image here it is img_product
                      {
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_recipient(recipient_gender,recipient_dob,recipient_age,bloodtype_id,user_id,recipient_regdate,recipient_medicalhistory,recipient_treatmenthsptl,recipient_status)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','"+session.getAttribute("uid")+"',curDate(),'" + proof + "','" + value[4]+ "',0)";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../User/Recipient.jsp'
