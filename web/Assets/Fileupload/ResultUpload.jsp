+<%-- 
    Document   : UserUpload
    Created on : 12 Jan, 2024, 10:39:33 AM
    Author     : DOYAL ELDHO
--%>
...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txt_report"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "Hphoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_result(report,docter_name,donor_id)values('"+photo +"','"+value[0]+"','"+value[1]+"') ";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Hospital/Result.jsp'
