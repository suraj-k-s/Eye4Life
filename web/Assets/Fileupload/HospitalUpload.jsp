...
//checking if request cotains multipart data
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_hospital(hosp_name,hosp_email,hosp_address,hosp_contact,hosp_logo,hosp_proof,hosp_password,place_id)values('" + value[0] + "','" + value[3] + "','" + value[1] + "','" + value[2] + "','" + photo + "','" + proof + "','"+ value[6] +"','"+value[5]+"')";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Guest/Hospital.jsp'
