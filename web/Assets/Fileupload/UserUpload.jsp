...
//checking if request cotains multipart data
           ...
           //to upload proof of doctor
               ...
               // {//Strinh str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_user(user_name,user_address,user_contact,user_email,user_photo,user_place,user_password)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','"+value[5]+"','"+ value[6] +"')";
