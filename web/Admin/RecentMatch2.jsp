...
<html>
    ...
    <body>
        ...
        <%
            int i=0;
            String selqry="select * from tbl_match m inner join tbl_donor d on m.donor_id=d.donor_id inner join tbl_user u on u.user_id=d.user_id  where donor_status='3' ";
            ResultSet s1=con.selectCommand(selqry);
            s1.next();
                
            String selQry="select *from tbl_match m1 inner join tbl_recipient r inner join  tbl_user u1 on u1.user_id=r.user_id where recipient_status='1'  ";
